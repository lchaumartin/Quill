...
//
// Quill/Effect/Glass — the whole ShaderEffect rect becomes a rounded pane of glass that refracts
// and blurs what is behind it, with a thin rim highlight and a soft top-down sheen. The Frost theme
// is built on it. The quad size comes from _Rect, and every length is in screen pixels.
//
