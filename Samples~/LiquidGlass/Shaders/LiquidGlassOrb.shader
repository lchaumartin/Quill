...
//
// Quill/Samples/LiquidGlassOrb — glossy, self-lit orbs for the Liquid Glass sample backdrop.
...
// Globals shared with the wallpaper: _LGExposure (0 = default 1), _LGWarmth, _LGCalm.
// Unlit and untagged: the same pass runs on URP (as SRPDefaultUnlit) and Built-in.
Shader "Quill/Samples/LiquidGlassOrb"
{
    Properties
    {
