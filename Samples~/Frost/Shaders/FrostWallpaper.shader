...
//
// Quill/Samples/FrostWallpaper — the animated backdrop of the Frost sample.
...
// Globals (set by FrostBackdrop.cs): _FrostExposure (0 = default 1), _FrostWarmth, _FrostCalm.
// Unlit and untagged: the same pass runs on URP (as SRPDefaultUnlit) and Built-in.
Shader "Quill/Samples/FrostWallpaper"
{
    Properties { }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                float t = _Time.y * (0.07 * lerp(1.0, 0.4, saturate(_FrostCalm)));
